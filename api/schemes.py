...
class UniqueAccountHeadsSchemes():
    ...
    def on_get(self, req, resp):
        ...
        Method for getting Permutations Combinations of account heads
        '''
        query_string = "SELECT `COLUMN_NAME`  FROM `INFORMATION_SCHEMA`.`COLUMNS`  WHERE `TABLE_SCHEMA`='himachal_pradesh_data' AND `TABLE_NAME`='himachal_budget_schemes_data'"  # pylint: disable=line-too-long
